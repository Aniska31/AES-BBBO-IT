...
namespace it_lab_12
{
    public partial class Form1 : Form
    {
        ...
        private void Tables()
        {
          ...
          input_data.Rows[0].Cells[0].Value = 2.0;
          input_data.Rows[1].Cells[0].Value = 2.2;
          input_data.Rows[2].Cells[0].Value = 2.4;
          input_data.Rows[3].Cells[0].Value = 2.6;
          input_data.Rows[4].Cells[0].Value = 2.8;
          input_data.Rows[5].Cells[0].Value = 3.0;
          input_data.Rows[0].Cells[1].Value = 4.0;
          input_data.Rows[1].Cells[1].Value = 2.0;
          input_data.Rows[2].Cells[1].Value = 4.0;
          input_data.Rows[3].Cells[1].Value = 2.0;
          input_data.Rows[4].Cells[1].Value = 5.0;
          input_data.Rows[5].Cells[1].Value = 2.0;
