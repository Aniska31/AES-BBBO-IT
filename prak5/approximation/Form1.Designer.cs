...
namespace it_lab_12
{
    partial class Form1
    {
      ...
      this.Equations.ChartAreas.Add(chartArea1);
      legend1.Name = "Legend1";
      this.Equations.Legends.Add(legend1);
      this.Equations.Location = new System.Drawing.Point(12, 218);
      this.Equations.Name = "Equations";
      series1.ChartArea = "ChartArea1";
      series1.Legend = "Legend1";
      series1.Name = "Series1";
      this.Equations.Series.Add(series1);
      ...
      // button1
      // 
      this.button1.Location = new System.Drawing.Point(857, 430);
